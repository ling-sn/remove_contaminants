...
class Bowtie2Aligner:
    ...
    def single_reads(self, file, mapped_folder, unmapped_folder):
        """
    ...
    def paired_reads(self, file, mapped_folder, unmapped_folder):
        """
            ...
            for file in subfolder.glob("*.fastq.gz"): ## iterate through indiv. files in subfolder
                try:
                    ...
                    if "_merged" in file.name or "_unpaired" in file.name:
                        aligner.single_reads(file, mapped_folder, unmapped_folder)
                    elif "_unmerged" in file.name:
                        aligner.paired_reads(file, mapped_folder, unmapped_folder)
