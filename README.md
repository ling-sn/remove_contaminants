...
* bowtie2 index
  * **Option 1 (Pre-Built; Recommended):** Skip bowtie2 index creation by using the permanent directory `~/umms-RNAlabDATA/Software/genome_indices/bowtie2_contam_index/contaminants_index`. This path is already included in the code by default, so nothing additional needs to be done.
